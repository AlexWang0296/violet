...
\begin{figure}[ht]
	...
	\caption{Model of the simulation(a) and sliced view of the model with no void(b), with void inside $\alpha_2$ phase(c) with void at $\alpha_2 / \gamma$ interface(d)}
...
\begin{figure}[ht]
	...
	\caption{(a) Fracture mode of two types of model  (b)Evolution of void at $\alpha_2 / \gamma$ phase boundary}
	\label{fig:void-gb}
\end{figure}
