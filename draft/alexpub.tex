...
The model without and type of void defect was regarded as benchmark of other simulation, deformation mechanisms was chose to . In order to examine deforamtion behaviour carefully, the whole tension process was sliced into four stages. Stage 1 is typical elasttic stage of the model, which is originate from strain $\epsilon = 0$ to $\epsilon = 0.09$. Stage 2 is yield stage of the model range from $\epsilon = 0.09$ to $\epsilon = $. stage 3.cracking stage and 4. Fracture stage. More specificially, a greater number of moments was snaped in stage 2 and stage 3.  
	\begin{figure}[ht]
		\centering
