...
The interaction of particle in the material is determined by interatomic potential. Many reported examples of crack propagation in metal materials were performed with embedded atomic method due to is better accuracy in metal lattice compare with F-S and L/J \cite{Goes1998}. The embedded atom method (MEAM) potential developed by Zope and Mishin \cite{Zope2003} was used in the study. The simulation is submitted by MD simulations with the Large-scale Atomic/Molecular Massively Parallel Simulator (LAMMPS) open-source code \cite{Plimpton1995}. We performed constant-pressure and constant-temperature (NPT) molecular dynamics simulation.
...
\begin{figure}[ht]
	...
	\caption{Atoms configuration around void ($\alpha$ phase atoms have been removed)}
	\label{fig:dis-void}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption{Schematic of Orowan process}
	\label{fig:dis-void}
\end{figure}
