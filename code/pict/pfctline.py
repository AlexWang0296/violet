...
ds1 = pd.read_csv('/home/alex/Documents/violet/code/data/stress_strain/pf.csv', sep=' ', skiprows=1, names=prop)
# /home/alex/Documents/violet/code/data/stress_strain/pf.csv
# plot lines
p1 = plt.plot(ds1.strain, ds1.stress, label='ia')
