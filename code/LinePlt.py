...
ds1 = pd.read_csv('data/aa.csv', sep=' ', skiprows=1, names=prop)
ds2 = pd.read_csv('data/ag.csv', sep=' ', skiprows=1, names=prop)
ds3 = pd.read_csv('data/pf.csv', sep=' ', skiprows=1, names=prop)
ds4 = pd.read_csv('data/ia.csv', sep=' ', skiprows=1, names=prop)
# plot lines
